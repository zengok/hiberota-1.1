...
class HomepageTests(TestCase):
    ...
    def test_homepage_lists_published_calls_and_featured_institutions(self) -> None:
        ...
        self.assertContains(response, "Araştırmacı")
        self.assertContains(response, "Girişimci")
        self.assertContains(response, "KOBİ/Firma")
        self.assertContains(response, "Kurumsal/Kamu/STK")
        self.assertContains(response, 'href="/cagrilar/?hedef=student&amp;hedef=graduate_student"')
        self.assertContains(response, 'href="/cagrilar/?hedef=academic"')
        self.assertContains(response, 'href="/cagrilar/?hedef=researcher"')
        self.assertContains(response, 'href="/cagrilar/?hedef=entrepreneur&amp;hedef=startup"')
        self.assertContains(response, 'href="/cagrilar/?hedef=sme&amp;hedef=company"')
        self.assertContains(
            response,
